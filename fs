...
#/dev/mapper/myvg2-mylvm	/ansible	ext4	defaults	1 2
/dev/sdc1    /devops/git-hub/git-repo     ext4 defaults 1 2
/dev/sdc3    swap swap defaults 0 0
/dev/sdc4    /nfsshare ext4 defaults 0 0 
/dev/sdc2    /ansible  ext4 defaults 0 0
